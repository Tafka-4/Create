...
import com.simibubi.create.foundation.mixin.accessor.FireBlockAccessor;
	...
	public CompletableFuture<?> run(CachedOutput cachedOutput) {
		return CompletableFuture.allOf(BuiltInRegistries.BLOCK.stream()
			...
			.map(block -> {
				...
				element.addProperty("flammable", ((FireBlockAccessor) Blocks.FIRE).create$canBurn(state));
