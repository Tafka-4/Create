...
public interface UnpackingHandler {
	 ...
	 */
	UnpackingHandler DEFAULT = (level, pos, state, side, items, orderContext, simulate) ->
		DefaultUnpackingHandler.INSTANCE.unpack(level, pos, state, side, items,
			orderContext == null ? null : orderContext.orderedStacks(), simulate);
